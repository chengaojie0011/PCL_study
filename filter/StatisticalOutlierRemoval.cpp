...
int main()
{
	...
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered2(new pcl::PointCloud<pcl::PointXYZ>); // 创建点云（指针）  
	...
	sor.filter(*cloud_filtered2);                    //执行滤波处理保存内点到cloud_filtered
	...
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> source_cloud_color_handler1(cloud_filtered2, 255, 120, 80);
	viewer->addPointCloud<pcl::PointXYZ>(cloud_filtered2, source_cloud_color_handler1, "sample cloud1", v1);
